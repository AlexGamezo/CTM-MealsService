...
namespace MealsService.Migrations
{
    ...
    [Migration("20170109054100_added DietGoal and MenuPreference models")]
    partial class addedDietGoalandMenuPreferencemodels
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MealsService.Models.DietGoal", b =>
                {
                    b.HasOne("MealsService.Models.DietType", "TargetDiet")
                        .WithMany()
