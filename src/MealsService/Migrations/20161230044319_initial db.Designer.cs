...
namespace MealsService.Migrations
{
    ...
    [Migration("20161230044319_initial db")]
            ...
            modelBuilder.Entity("MealsService.Models.ScheduleDay", b =>
                {
                    ...
                    b.Property<int?>("DietTypeId1");

                    b.Property<int?>("DietTypeIdId");
                    ...
                    b.HasIndex("DietTypeId1");

                    b.HasIndex("DietTypeIdId");
            ...
            modelBuilder.Entity("MealsService.Models.ScheduleDay", b =>
                {
                    b.HasOne("MealsService.Models.DietType", "DietType")
                        .WithMany()
                        .HasForeignKey("DietTypeId1");

                    b.HasOne("MealsService.Models.DietType", "DietTypeId")
                        .WithMany()
                        .HasForeignKey("DietTypeIdId");
                });
